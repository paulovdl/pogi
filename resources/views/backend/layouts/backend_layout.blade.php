...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('ssets/images/favicon.png') }}">
    <title>Backend Sample template</title>
    <!-- Custom CSS -->
    ...
    <link href="{{ asset('css/backend_css/uniform.css') }}" rel="stylesheet">
